...
//$rqData->geolocation  = new Geolocation('-60.64836', '-32.937182',5, '-60.64899','-32.937199');
$location  = new Geolocation();
$location->longitude = floatval('-60.64836');
$location->latitude = floatval('-32.937182');
$location->radius = 2;
$location->unit = 'km';
$rqData->geolocation =  $location ;
//print_r($location);
